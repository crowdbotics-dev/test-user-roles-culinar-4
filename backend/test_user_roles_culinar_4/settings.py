"""
Django settings for test_user_roles_culinar_4 project.
...
ROOT_URLCONF = 'test_user_roles_culinar_4.urls'
...
WSGI_APPLICATION = 'test_user_roles_culinar_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_user_roles_culinar_4 API",
    "DESCRIPTION": "API documentation for test_user_roles_culinar_4 App",
    "VERSION": "v1",
}
